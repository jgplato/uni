...
Die $x$-Koordinate des Schwerpunktes ist dann
\begin{align*}
...
\begin{enumerate}[a)]
  ...
  \item
    ...
    %Schwerpunkt für eine andere Kurve (nämlich die Kurve oberhalb oder
    %unterhalb der $x$-Achse zu berechnen (bei einer Rotation um dieselbige)).
    %Da aber nichts dergleichen gegeben ist (wir müssten ja wissen, ob Ober-
    %oder Unterseite), nehmen wir den Schwerpunkt für genau die selbe Kurve.

    Die $y$-Koordinate des Schwerpunktes liegt bei
    \begin{align*}
