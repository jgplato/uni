...
Dies haben wir jeweils für jede der 5 Massen, die beiden verschiedenen Drehrichtungen
...
sehr genaue Ort-Zeit-Kurve extrahieren konnten. Insgesamt haben wir so über
38.000 Messpunkte extrahiert.
...
Dazu werden zuerst im Video über ein statisches Matching sechs feste
Punkte erkannt, um die Orientierung des Experiments gegenüber der Kamera zu
berechnen. Folgende Punkte haben sich dabei als gut erkennbar herausgestellt:
\begin{enumerate}
...
\end{wrapfigure}
Sofern der Zeiger in einer von drei verschiedenen Zonen (siehe Abbildung) ist,
