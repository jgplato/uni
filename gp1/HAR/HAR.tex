...
% FIXME: Fehler in der Zeit falsch. Auch im Plot. Korrigieren!
\begin{tabular}{r|r}
  $t$ [s] & $A$ [cm] \\
  \hline
...
Die Eigenfrequenz erhalten wir aus Gleichung TODO FIXME als: % TODO: Das muss
% im theoretischen Teil rein
\begin{equation}
  \omega_0 = \sqrt{\omega^2  + \delta^2}
\end{equation}

% FIXME: Fehlerrechnung
