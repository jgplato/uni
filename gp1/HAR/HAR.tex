...
\newpage
\section{Ausdrucke}
\subsection{Freies Ausschwingen bei Dämpfung 2}
\newpage
\subsection{Einschwingvorgang nahe der Resonanz}
\newpage
\subsection{Einschwingvorgang im Resonanzfall}
\newpage
...
\label{plot:damp}
\invisiblesubsection{Dämpfungskurve}
\begin{landscape}
...
\newpage
\label{plot:amp}
\invisiblesubsection{Resonanzkurve}
\begin{landscape}
