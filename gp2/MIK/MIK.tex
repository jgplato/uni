...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    % Parallelstrahl
    \draw (-\objectDistance,\objectHeight) -- node[above] {g} (0,\objectHeight) -- (\pictureDistance,-\pictureHeight);

    % Brennpunktstrahl
    \draw (-\objectDistance,\objectHeight) -- (0,-\pictureHeight) -- node[below] {b} (\pictureDistance,-\pictureHeight);
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    % Hervorrhebung
    \draw[thick,color=red] (0,0) -- node[color=black,right=0.2cm] {$G$} (0,\objectHeight) -- (\focalLength,0) -- node[color=black,above] {$f$} cycle;
