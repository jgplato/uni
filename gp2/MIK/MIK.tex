...
Aufbaue wie Aufgabe 2, jedoch wurde in die Zwischenbildebene des Mikroskops
die 1/10-mm-Skala entgesetzt. Die beleuchtete Skala wurde durch ein Drahtnetz
ersetzt. 

% FIXME: Können wir die Werte errechnen?
Die Kalibrierung wurde vergessen.


Anschließend wurde der Gitterabstand und die Drahtstärke gemessen.
...
% FIXME: Kleine Skala: Werte um Faktor 10 zu klein, weil dachte, große
% Unterteilungen sind 1/10 mm. In wirklichkeit sind kleine.
...
Der Abbildungsmaßstab in der ersten Position ist

\begin{equation}
  \beta_1 = \frac{(5\pm1) \operatorname{mm}}{(0{,}3 \pm 0{,}01 \operatorname{mm}} = 
\end{equation}
...
\begin{equation}
  g - b = (22{,}30 \pm 0{,}05) \operatorname{cm}
        - (17{,}40 \pm 0{,}05) \operatorname{cm} = (49{,}0 \pm 0{,}7) \operatorname{mm}
\end{equation}

Damit ergibt sich die Brennweite
...
\subsection{Aufgabe 3}
% FIXME
Der theoretische Vergrößerungsfaktor ist ...

\subsection{Aufgabe 4}
% FIXME: Kalibrierung nachrechnen!
